  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        responseData?.data.usertype === "superadmin" ||
        responseData?.data.usertype === "admin"
          ? navigate("/details")
          : navigate("/campaign");
            ...
            <section>
              <form onSubmit={handleSubmit}>
                <div className="form-group1">
                  {error && (
                    <div
                      className="alert alert-danger alert-message"
                      role="alert"
                    >
                ...
                <br />
                <br />
                <button type="submit" className="btn-create-campaign">
                  Login
                </button>
              </form>
            </section>
